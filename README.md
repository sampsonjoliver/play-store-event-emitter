...
This Google play emitter is specifically designed to push state changes from the Google Play Store. For code simplicity and cost, event repeatability and state management, is ultimately left up to the event consumers.
...
```bash
aws cloudformation delete-stack --stack-name play-store-event-emitter
```
